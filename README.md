...
管理器内置独立的生命周期总线，支持无需经过 Yunzai 框架的 HMR 热重载与自动热更新本体，长期迭代下已设计出非常强大的网络层的支撑能力足够应对图库管理的各种挑战。

#### 管理器当期版本

> [!TIP]
> ©️ v5.2.1 测试版  <br>
> 未来计划 No.2 v5.2.2 Ws互联管理端
...
<details>
  <summary>面板图预览-点击展开/折叠内容</summary>

<p align="center">
  <img src="./gs-character/哥伦比娅/哥伦比娅Gu5.webp" width="100%">
</p>

<p align="center">
  <img src="./gs-character/哥伦比娅/哥伦比娅Gu13.webp" width="100%">
</p>

<p align="center">
  <img src="./gs-character/哥伦比娅/哥伦比娅Gu16.webp" width="100%">
</p>
...
> [!TIP]  
> 使用咕咕牛管理器安装以下社区图库可以最大化避免Git冲突&管理混乱&文件重叠的问题，以下是近半年仍在更新的图库，按创建日期排序。

| 维护者 | 仓库URL | 仓库描述 |
| :--- | :--- | :--- |
| 夜 | https://github.com/ye3011/normal-character | 喵喵面板图 |
| 何日见 | https://github.com/herijian1/characterpic | 喵喵插件原神星铁高质量面板图 |
